...
public class BiWeekly {
    public void BWexpensis(double income, double wexpenses){

        Scanner s = new Scanner(System.in);
        System.out.println("Please input your Bi-Weekly income");
        income = s.nextDouble();

        System.out.println("Input your weekly expenses");
        wexpenses = s.nextDouble();

        double x = income - (wexpenses*2);
        ...
        if(a.equalsIgnoreCase("yes")) {
            ...
            System.out.println("Would you like to use the same income again for a future Bi-Weekly estimate?");
            ...
            while (yes != 0) {
                ...
                sum += d;
                System.out.println("Week count: " + i + "\nBi-Weekly savings added together...." + sum);
                System.out.println("Would you like to see next Bi-Weekly savings?");
                System.out.println("Press 1 for yes, 0 for no and press 'Enter' ");
                yes = s.nextInt();
            }
