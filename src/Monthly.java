...
public class Monthly {
    public void MWexpensis(double income, double wexpenses, double mexpenses){

        Scanner s = new Scanner(System.in);
        System.out.println("Please input your monthly income");
        income = s.nextDouble();

        System.out.println("Input your weekly expenses");
        wexpenses = s.nextDouble();

        System.out.println("Please input your monthly expenses");
        mexpenses = s.nextDouble();

        double x = income - (wexpenses + mexpenses);
        ...
        if(a.equalsIgnoreCase("yes")) {
            ...
            System.out.println("Would you like to use the same income again for a future monthly estimate?");
            ...
            while (yes != 0) {
                ...
                sum += d;
                System.out.println("Month count: " + i + "\nMonthly savings added together...." + sum);
                System.out.println("Would you like to see next months savings?");
                System.out.println("Press 1 for yes, 0 for no and press 'Enter' ");
                yes = s.nextInt();
            }
