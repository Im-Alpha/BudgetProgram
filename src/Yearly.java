...
import java.util.*;
public class Yearly {
    public void YWexpensis(double income, double wexpenses, double mexpenses){
        ...
        double x = income - ((wexpenses*12)+(mexpenses*12));
        ...
        if(a.equalsIgnoreCase("yes")) {
            ...
            System.out.println("Would you like to use the same income again for a future yearly estimate?");
            ...
            while (yes != 0) {
                ...
                sum += d;
                System.out.println("Year count: " + i + "\nYearly savings added together...." + sum);
                System.out.println("Would you like to see next years savings?");
                System.out.println("Press 1 for yes, 0 for no and press 'Enter' ");
                yes = s.nextInt();
            }
